...
public class SelectHeadTools {
     ...
     * @param uri  Uri
     */
    public static void openDialog(final View.OnClickListener context, final Uri uri){
        new ActionSheetDialog((Context) context)
                .builder()
                .setTitle("选择图片")
                .setCancelable(true)
                ...
                .addSheetItem("拍照", ActionSheetDialog.SheetItemColor.Red, new ActionSheetDialog.OnSheetItemClickListener() {
                    ...
                    public void onClick(int which) {
                        startCamearPicCut((Activity) context,uri);
                    }
                })
